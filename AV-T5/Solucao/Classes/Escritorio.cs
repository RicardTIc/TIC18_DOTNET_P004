...
class Escritorio
{
    ...
    public void RegistrarPagamento(Cliente cliente, IPagamento pagamento)
    {
    ...
    public static void Main()
    {
        ...
        Advogado advogado = new Advogado("Advogado1", new DateTime(1980, 1, 1), "12345678901", "123456789");
            escritorio.Advogados.Add(advogado);

            Cliente cliente = new Cliente("Cliente1", new DateTime(1980, 1, 1), "12345678901", "Solteiro", "Advogado");
