 ...
 public class PlanoConsultoria
    {
        ...
        {
            return this.Titulo + " - " + this.ValorPorMes + " - " + string.Join(", ", this.Beneficios);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is PlanoConsultoria)
            {
                ...
                return this.Titulo == plano.Titulo && this.ValorPorMes == plano.ValorPorMes && this.Beneficios.SequenceEqual(plano.Beneficios);
            }
            return false;
        }
